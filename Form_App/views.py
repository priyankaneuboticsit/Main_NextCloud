...
# because function name and import module name nao will be same.
...
def register(request, num='Standard'):
    ...
    return render(request, 'Form_App/register.html',{'num' : num})
...
def send_email_after_register(email, token):
    ...
    message = f'Your Username And Password Will be Generate Within 24 Hour. Hi paste the link to verify your account - {token}. '
